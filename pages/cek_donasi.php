...
<body>
    ...
    <div class="container text-center mb-5">
        <h1 class="mt-5"> Admin Cek Donasi </h1>

        <div class="row mt-5 mb-5">
            <div class="col-md-6 mb-3">
                <span class="panti_A"></span>
                <br>
                <span>Jumlah Donasi Panti Asuhan Panti Asuhan Rumah Bersinar</span>
            </div>

            <div class="col-md-6 mb-3">
                <span class="panti_B"></span>
                <br>
                <span>Jumlah Donasi Panti Asuhan Panti Asuhan Saluran Berkat</span>            
            </div>
        </div>
            ...
            <table class="text-center" id="table_donasi">
                ...
                <tbody>
                    <?php
                        ...
                        $find_data = $pdo->prepare("SELECT `id`, `nama_donatur`, `nomor_telepon`, `lokasi_donasi`, `jumlah_donasi`, `bukti_trf`, `date` FROM `data_donasi` ORDER BY id ASC");
                        $find_data ->execute([]);
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header mymodalstyle">
              <h5 class="modal-title" id="alasanfotoUMKM"></h5>
    ...
    <script>
        ...
        function getcount() {
            var amount;
            $.ajax({
                url: "request/ajax_count.php",
                type: "POST",
                data: amount,
                dateType: 'JSON',
                success: function(action) {
                    action = JSON.parse(action);
                    $('.panti_A').text(action.donasi_a);
                    $('.panti_B').text(action.donasi_b);
                }
            });
        }
