    ...
    <div class="container">
        ...
        <div class="row form-upload">
            <div class="col-12 text-center" align="center">
                <h1 class="title" data-aos="zoom-in-down">Orang Tua Asuh</h1>
            </div>
            <div class="col-12 mt-3">
                <label for="a" class="form-label" data-aos="zoom-in">Nama Orang Tua Asuh :</label>
            ...
            <div class="col-12 mt-3">
                <label for="r" class="form-label" data-aos="zoom-in">Anak Asuh :</label>
                <br>
                <select name="r" id="r" data-aos="fade-left" >
                    <option hidden>Pilih Anak Asuh</option>
                    
                </select>
            </div>

            <div class="col-12 mt-3">
                <label for="e" class="form-label" data-aos="zoom-in">Nominal <i class="fas fa-info-circle" id="info" type="button" data-bs-toggle="tooltip" data-bs-placement="top" title="Masukkan nominal tanpa titik"></i> :</label> 
                <input type="number" class="input-form" data-aos="fade-left" id="e">
            </div>
            
            
            <div class="col-8 mt-3">
                <label for="" class="form-label" data-aos="zoom-in">BRI a/n. Yayasan Rumah Bersinar</label> 
                <p id="pRM" class="input-form" >
          202901000346563
        </p>
        ...
        <button onclick="copyClipboard('pRM')" class="confirm" style="margin-top:30px">Copy No Rek</button>
            </div>
            
            
                 <div class="col-8 mt-3">
                <label for="" class="form-label" data-aos="zoom-in">BCA a/n. Yayasan Rumah Bersinar</label> 
        ...
        <button onclick="copyClipboard('pRM2')" class="confirm" style="margin-top:30px">Copy No Rek</button>
            </div>
            
           
        <!--    
            <div class="col-12 mt-3">
                <img src="" alt="gambar QR" class="QR text-center" data-aos="zoom-in">
            </div>-->

            <div class="col-12 mt-3 bukti_trf">
                <label  for="b" class="form-label mt-3" data-aos="zoom-in">Bukti Transfer :</label> 
                <br>
