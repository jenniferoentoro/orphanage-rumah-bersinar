...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-2">
            <!-- HTML !-->
            <button id="addSubmit" data-bs-toggle="modal" data-bs-target="#modalSubmit" class="button-27" role="button">+ Add Moment</button>
    ...
    <img height="100px" weight="auto" alt="'.$result['tanggal'].'-'.$result['judul'].'" src="'.$result['filePath'].'"></a><br>
    <a download="'.$result['tanggal'].'-'.$result['judul'].'" href="'.$result['filePath'].'" title="'.$result['tanggal'].'-'.$result['judul'].'">Download</a></td>
